...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.4\textwidth]{imagenes/physionet-logo.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{imagenes/sqlvsnosql.jpg}}
    %\includegraphics[width=0.4\textwidth]{imagenes/physionet-logo.png}
...
%begin{figure}[H]
%    \centering
%    \fbox{\includegraphics[width=0.75\textwidth]{imagenes/Cliente-Servidor.png}}
%    %\includegraphics[width=0.4\textwidth]{imagenes/physionet-logo.png}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{imagenes/Cliente-Servidor.png}}
    %\includegraphics[width=0.4\textwidth]{imagenes/physionet-logo.png}
    \caption{Diagrama cliente-servidor \cite{clienteservidorfoto}.}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=1\textwidth]{imagenes/grafica_frameworks.png}}
...
\begin{figure}[H]
    \centering    \fbox{\includegraphics[width=0.85\textwidth]{imagenes/d3.png}}
    %\includegraphics[width=0.4\textwidth]{imagenes/physionet-logo.png}
